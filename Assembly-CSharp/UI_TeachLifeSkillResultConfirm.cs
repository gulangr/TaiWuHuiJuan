...
public class UI_TeachLifeSkillResultConfirm : UIBase
{
	// Token: 0x0600388A RID: 14474 RVA: 0x001C8930 File Offset: 0x001C6B30
	public override void OnInit(ArgumentBox argsBox)
	{
		...
		{
			this.InitRefers();
			this._displayTeachResult = new List<UI_TeachLifeSkillResultConfirm.TeachResultItemData>();
		}
	...
	// Token: 0x0600388B RID: 14475 RVA: 0x001C8990 File Offset: 0x001C6B90
	...
	// Token: 0x0600388C RID: 14476 RVA: 0x001C8B00 File Offset: 0x001C6D00
	...
	// Token: 0x0600388D RID: 14477 RVA: 0x001C8B3C File Offset: 0x001C6D3C
	private void SetData(int charId)
	{
		UI_TeachLifeSkillResultConfirm.<>c__DisplayClass16_0 CS$<>8__locals1 = new UI_TeachLifeSkillResultConfirm.<>c__DisplayClass16_0();
		...
		using (Dictionary<IntPair, ushort>.Enumerator enumerator3 = this._teachCombatSkillResult.RelationChangeData.GetEnumerator())
		{
			...
			{
				UI_TeachLifeSkillResultConfirm.<>c__DisplayClass16_1 CS$<>8__locals2 = new UI_TeachLifeSkillResultConfirm.<>c__DisplayClass16_1();
		...
		UI_TeachLifeSkillResultConfirm.TeachResultItemData teachResultItemData = new UI_TeachLifeSkillResultConfirm.TeachResultItemData(CS$<>8__locals1.charId, CS$<>8__locals1.characterDisplayData, readBookPageData, favorabilityChangeData, relationChangeData);
		this._displayTeachResult.Add(teachResultItemData);
	}

	// Token: 0x0600388E RID: 14478 RVA: 0x001C9000 File Offset: 0x001C7200
	...
	// Token: 0x0600388F RID: 14479 RVA: 0x001C9094 File Offset: 0x001C7294
	...
	// Token: 0x06003890 RID: 14480 RVA: 0x001C90E0 File Offset: 0x001C72E0
	...
	// Token: 0x06003891 RID: 14481 RVA: 0x001C9120 File Offset: 0x001C7320
	...
	// Token: 0x06003892 RID: 14482 RVA: 0x001C915C File Offset: 0x001C735C
	...
	// Token: 0x06003893 RID: 14483 RVA: 0x001C91C8 File Offset: 0x001C73C8
	...
	// Token: 0x06003894 RID: 14484 RVA: 0x001C9244 File Offset: 0x001C7444
	private void OnItemRender(int index, Refers refers)
	{
		UI_TeachLifeSkillResultConfirm.TeachResultItemData teachResultItemData = this._displayTeachResult[index];
	...
	// Token: 0x06003895 RID: 14485 RVA: 0x001C9294 File Offset: 0x001C7494
	private void Update()
	{
	...
	// Token: 0x06003896 RID: 14486 RVA: 0x001C92DE File Offset: 0x001C74DE
	private void HideUI()
	{
	...
	// Token: 0x06003897 RID: 14487 RVA: 0x001C9304 File Offset: 0x001C7504
	...
	private List<UI_TeachLifeSkillResultConfirm.TeachResultItemData> _displayTeachResult;
	...
	{
		// Token: 0x0600D5E3 RID: 54755 RVA: 0x005BAA70 File Offset: 0x005B8C70
